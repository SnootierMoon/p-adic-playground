...
Earlier I claimed that the p-adics are a field extension of the rational numbers. But what is the equivalence class of a fraction modula a prime power? How does it make sense to ask about the residue of $2 / 3 \pmod {5}$ That unfortunately involves a little bit more complex algebra, you'll need the [modular multiplicative inverse](https://wikipedia.org/wiki/Modular_multiplicative_inverse).
